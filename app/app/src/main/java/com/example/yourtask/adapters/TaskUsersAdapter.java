...
public class TaskUsersAdapter extends ArrayAdapter<User>
{
    ...
    public TaskUsersAdapter(Context context, ArrayList<User> items, int id_task)
    {
            ...
            public void onClick(View v)
            {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener()
                {
                    ...
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        ...
                        {
                            ApiRequest.deleteUtenteTask(user.id, id_task, new ReceiveDataCallback<RequestResult>() {
                                @Override
